...
/**
 * This class defines the specific method of a Ground Transport.
 ...
 * @author Nicolas Brax
 */
public class GroundTransport extends GroundUnit{
   ...
   */
  private final String GENERIC_NAME = "Ground Transport";
   ...
   */
  public GroundTransport() throws WCException{
   ...
   */
  public GroundTransport(int team,int nb, int x, int y) throws WCException{
   ...
   * As a Ground Transport, it is computed as follow:
   * ---
   ...
   * is a Ground Transport, it consists in:
   * - ---
   * - ---
   * - ---
   */
