...
/**
 * This class defines the specific method of a ScoutPlane.
 ...
 * @author Nicolas Brax
 */
public class ScoutPlane extends AirUnit{
   ...
   */
  private final String GENERIC_NAME = "Scout Plane";
   ...
   */
  public ScoutPlane(int team,int nb, int x, int y, String camp){
   ...
   * As a Scout Plane, it is computed as follow:
   * ---
   ...
   * is a Scout Plane, it consists in:
   * - ---
   * - ---
   * - ---
   */
