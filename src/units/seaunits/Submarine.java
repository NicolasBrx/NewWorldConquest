...
/**
 * This class defines the specific method of a Submarine unit.
...
public class Submarine extends SeaUnit{
   ...
   */
  private final String GENERIC_NAME = "Submarine";
   ...
   */
  public Submarine() throws WCException{
   ...
   */
  public Submarine(int team,int nb, int x, int y,String harbour) throws WCException{
   ...
   * As a Submarine unit, it is computed as follow:
   * ---
   ...
   * is a Submarine unit, it consists in:
   * - ---
   * - ---
   * - ---
   */
