...
/**
 * This class defines the specific method of a Destroyer unit.
...
public class Destroyer extends SeaUnit{
   ...
   */
  private final String GENERIC_NAME = "Destroyer";
   ...
   */
  public Destroyer() throws WCException{
   ...
   */
  public Destroyer(int team,int nb, int x, int y,String harbour) throws WCException{
   ...
   * As a Destroyer unit, it is computed as follow:
   * ---
   ...
   * is a Destroyer unit, it consists in:
   * - ---
   * - ---
   * - ---
   */
