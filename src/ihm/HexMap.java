...
public class HexMap
{
  private HexMap() {
	...
	final static Color COLOURCELL =  Color.BLUE;	 
	...
	final static int BSIZE = 50; //board size.
	final static int HEXSIZE = 25;	//hex size in pixels
